...
#define NUCLEO_SCK_PIN						GPIO_PIN_10  // GPIO_C10

#define NUCLEO_MOSI_PIN						GPIO_PIN_12  // GPIO_C12

#define NUCLEO_MISO_PIN						GPIO_PIN_11  // GPIO_C11

#define NUCLEO_SPI_GPIO_PORT			GPIOC
...
#define NUCLEO_SPI_CLOCK_ENABLE()								__GPIOC_CLK_ENABLE()
