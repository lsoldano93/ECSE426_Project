...
#define NUCLEO_DATAi0_PIN						GPIO_PIN_5  // GPIO_C5

#define NUCLEO_DATAi1_GPIO_PORT			GPIOC
#define NUCLEO_DATAi1_PIN						GPIO_PIN_6  // GPIO_C6

#define NUCLEO_DATAi2_GPIO_PORT			GPIOC
#define NUCLEO_DATAi2_PIN						GPIO_PIN_8  // GPIO_C8

#define NUCLEO_DATAi3_GPIO_PORT			GPIOC
#define NUCLEO_DATAi3_PIN						GPIO_PIN_9  // GPIO_C9
...
#define DISCOVERY_TO_NUCLEO_PIN						GPIO_PIN_7  // GPIO_A2


#define NUCLEO_DATAo_CLOCK_ENABLE()		__GPIOB_CLK_ENABLE()
#define NUCLEO_HS_CLOCK_ENABLE()		__GPIOA_CLK_ENABLE()
